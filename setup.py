...
with open('demos/version.py', 'w') as version_file:
...
setup(
    ...
    url='https://github.com/imodels/demos',
    download_url='https://github.com/imodels/demos/tarball/{}'.format(__version__),
    packages=find_packages(),
    package_dir={'demos': 'demos'},
